...
export function MakkahSchedulePage() {
  ...
  if (isLoading) {
    return (
      <>
        <Helmet>
          <title>جدول أئمة التراويح والتهجد بالمسجد الحرام — رمضان ١٤٤٧</title>
        </Helmet>
        <ScheduleSkeleton />
      </>
    )
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="جدول أئمة صلاة التراويح والتهجد بالمسجد الحرام لرمضان ١٤٤٧ هـ — السديس، المعيقلي، الدوسري، بندر بليلة، الجهني وآخرون. جدول ٣٠ ليلة مع تفصيل التسليمات"
        />
      </Helmet>
